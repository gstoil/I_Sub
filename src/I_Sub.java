 ...
 *
 * Particularly useful when intending to match strings representing different types (entities, concepts, classes)
 * and properties from two different dictionaries/ontologies/taxonomies. For example, one medical taxonomy may have
 * concept labelled "Venography of left upper limb" whereas another may have the same concept labelled "Left upper limb venogram".
 *
 *
 */
public class I_Sub {
	...
	public static void main(String[] args) {
		System.out.println(I_Sub.score("has part", "hasPart"));
		System.out.println(I_Sub.score("Venography of left upper limb", "Left upper limb venogram"));
		System.out.println(I_Sub.score("IndianRestaurant", "Restaurant with Indian cuisine"));
	}
}
